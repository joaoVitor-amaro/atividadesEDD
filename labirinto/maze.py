...
class Maze:
    ...
    def solve_backtracking(self):
        '''
        Resolve o labirinto usando backtracking com uma pilha.
        Mostra o jogador se movendo na tela.
        '''
        stack = []
        visited = set()
        ...
        while stack:
            ...
            if last_pos:
                ...
                if self.M[last_pos[0], last_pos[1]] == Maze.PLAYER:
                    self.M[last_pos[0], last_pos[1]] = Maze.HALL

            if self.find_prize(pos):
                self.M[pos[0], pos[1]] = Maze.PLAYER
                pygame.event.pump()
                time.sleep(0.05)
